export default function handler(req, res) {
    ...
    if (hiraganaRegex.test(name) && !/\s/.test(name)) {
        ...
        if (name === "はやさきはると") {
        ...
        } else if (name === "うしおしゅんた") {
            res.redirect(307, process.env.tsukuru_u_syunta_URL);
        } else if (name === "かわきたえいた") {
            res.redirect(307, process.env.tsukuru_k_eita_URL);
        } else if (name === "くばせつな") {
            res.redirect(307, process.env.tsukuru_k_setuna_URL);
        } else if (name === "まつだたける") {
            res.redirect(307, process.env.tsukuru_m_takeru_URL);
        } else if (name === "いわもとなつみ") {
            res.redirect(307, process.env.tsukuru_i_natumi_URL);
        } else if (name === "いわもとさゆみ") {
            res.redirect(307, process.env.tsukuru_i_sayumi_URL);
        } else if (name === "たなはらごうき") {
            res.redirect(307, process.env.tsukuru_t_gouki_URL);
        } else if (name === "うらそえゆうい") {
            res.redirect(307, process.env.tsukuru_u_yui_URL);
        } else if (name === "うらそえしょうり") {
            res.redirect(307, process.env.tsukuru_u_shori_URL);
        } else if (name === "しまぶくろあいみ") {
            res.redirect(307, process.env.tsukuru_s_aimi_URL);
        } else if (name === "きんじょうあいたろう") {
            res.redirect(307, process.env.tsukuru_k_aitarou_URL);
        } else if (name === "うすいけい") {
            res.redirect(307, process.env.tsukuru_u_kei_URL2);
        } else if (name === "いさしんと") {
            res.redirect(307, process.env.kids_shinto_URL);
        } else if (name === "またよしこうき") {
            res.redirect(307, process.env.tsukuru_m_kouki_URL);
        } else if (name === "ふくちゆうすけ") {
            res.redirect(307, process.env.tsukuru_f_yusuke_URL);
        } else if (name === "にしだほたか") {
            res.redirect(307, process.env.tsukuru_n_hotaka_URL);
            ...
            res.redirect(307, process.env.tsukuru_h_syun_URL);
        } else if (name === "ぎまひろと") {
            res.redirect(307, process.env.tsukuru_ghiroto_URL);
        } else if (name === "みやぎなつめ") {
            res.redirect(307, process.env.tsukuru_natsume_URL);
        } else if (name === "かとうくるみ") {
            res.redirect(307, process.env.tsukuru_kurumi_URL);
        } else if (name === "かとうあおと") {
            res.redirect(307, process.env.tsukuru_aoto_URL);
        } else if (name === "かとうみり") {
            res.redirect(307, process.env.tsukuru_miri_URL);     
        } else {
